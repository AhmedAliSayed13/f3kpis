...
# === path to files 
path1 <- "RCODE/report_29.xlsx"
#path2 <- "RCODE/report_1.docx"
path3 <- "RCODE/report_29.html"
tble_head <- read.table("report_29_head.txt", sep = "\t")
