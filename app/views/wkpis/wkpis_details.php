...
<include href="/layouts/nav.html" />
  <repeat group="{{ @kpi }}" value="{{ @kpidetails }}">
...
<div class="container-fluid" id="data-container">
  <ul class="nav nav-pills" id="pills-tab" role="tablist">
   <li class="nav-item" >
    ...
    <!-- <check if="in_array( {{@kpidetails.kpi_id}} , @ids)">
    <li class="nav-item" >
              ...
              <div style="position:relative"  >
                <form method="POST" action="/wkpis/executeupdate/{{@PARAMS.kpi_id}}"   >
                  ...
                  <li class="list-inline-item">
                    ...
                    <input id="hijri-picker2" type="text" value= "  <check if="{{@to}} != ''"> <true>  {{@to}} </true>   </check>" class="form-control" name="form_todate" onkeyup="addHyphen(this)"  />
                  </li>
      ...
      <div id="table_div" >
        <div class="card-body">
          <div class="container-fluid statics">
            ...
            <loop from="{{ @i=0 }}" to="{{ @i < count(  @num2 ) }}" step="{{ @i++ }}">
