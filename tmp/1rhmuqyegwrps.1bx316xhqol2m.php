                        ...
                        <ul class="list-unstyled">
                          <?php for ($i=0;$i < count($reports);$i++): ?>
                            <?php if (trim($reports[$i]['rep_cat'])  == 10): ?>
                              ...
                              <?php else: ?><li><a class=" btn-primary text-white  " href="/report/table2/<?= ($reports[$i]["rep_id"]) ?>" title=" عرض كامل الفترة "><i class="fas fa-eye"></i></a> <a   href="/report/modal/<?= ($reports[$i]["rep_id"]) ?>" class='li-modal text-white   btn-info' title="تحديد فترة "><i class="fa fa-calendar" aria-hidden="true"></i></a></a>  <p> <?= ($reports[$i]["rep_title"]) ?> </p>
                        ...
                        <div class="card-body ">
                          <ul class="list-unstyled">
                            <?php for ($i=0;$i < count($reports);$i++): ?>
                              ...
                              <?php else: ?><li><a class=" btn-primary text-white "   href="/report/table2/<?= ($reports[$i]["rep_id"]) ?>" title=" عرض كامل الفترة "><i class="fas fa-eye"></i></a> <a   href="/report/modal/<?= ($reports[$i]["rep_id"]) ?>" class='li-modal text-white   btn-info' title="تحديد فترة "><i class="fa fa-calendar" aria-hidden="true"></i></a></a>  <p style="font: normal normal 600 14px/22px Cairo !important;"> <?= ($reports[$i]["rep_title"]) ?> </p>
                          ...
                          <ul class="list-unstyled">
                            <?php for ($i=0;$i < count($reports);$i++): ?>
                              <?php if (trim($reports[$i]['rep_cat'])  == 16): ?>
                                ...
                                <li>
                                  <a class=" btn-primary text-white" href="/report/table2/<?= ($reports[$i]["rep_id"]) ?>" title=" عرض كامل الفترة "><i class="fas fa-eye"></i></a>
