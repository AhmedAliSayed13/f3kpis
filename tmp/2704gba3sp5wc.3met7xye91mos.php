                ...
                <div class="row">
                  <div class="col-lg-8 col-md-8 text-right">
                    ...
                    <div class="page-data-content">
                      <h3> <a href="/wkpis/home" class="a1" style="color: #272d3b; text-decoration: none;">الرئيسية / </a><a href="/report/list" style="color: #272d3b; text-decoration: none;"> نماذج البحث و الأسترجاع</a> </h3>
                      <p>   <span> <?= ($reports['rep_title']) ?></span> </p>
                      <?php if ($from  != ''): ?>

                         <p id ="p_span">    من  <span class="p_span"><?= ($from) ?> </span>  الي  <span id="hijri1" class="p_span">  </span> </p>
     ...
     <div class="row">
       <div class="col-md-1"></div>
        <div class="col-md-10 div_table"  >
         <?php echo $this->render('../../RCODE/report_'.$rep_id.'.html',NULL,get_defined_vars(),0); ?>
         </div>
      </div>
  </div>
  </td>
  	...
  	<div class="button"><span>  تصدير </span></div>
  		<div class="body">
  		 <div class="form-group">
             <a href="/RCODE/report_<?= ($rep_id) ?>.xlsx"  > Excel  </a>
