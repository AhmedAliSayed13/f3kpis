...
<script>
  ...
  function createPDF() {
     ...
     // var sTable2 =  document.getElementById("chart-container").innerHTML;
      ...
      style = style + "p {margin: 10px auto; text-align: right; font-size:20px ;font-family: 'Cairo', sans-serif; }";
     ...
     style = style + ".p_span{ display: inline-block;    padding: 0px 5px; }";
      ...
      style = style + ".text-right {   padding-right: 45px; margin-top: 0px;border-top: 60px solid #0c8575;}";
