...
<head>
    ...
    <link href="http://localhost:8000/ui/css/bootstrap-datetimepicker.min.css" rel="stylesheet" />
...
<li class="list-inline-item">
  <button type="submit" value="Update KPI" class="date-item"  >تحديث</button>
    ...
    <script src="http://localhost:8000/ui/js/bootstrap-hijri-datetimepickermin.js"></script>
