        ...
        <div class="row">
          <div class="col-lg-8 col-md-8 text-right">
            ...
            <div class="page-data-content">
              <h3> <a href="/wkpis/home" style="color: #272d3b; text-decoration: none;">الرئيسية / </a><a href="/wkpis/kpi" style="color: #272d3b; text-decoration: none;">مؤشرات الأداء </a></h3>
...
<div class="container-fluid" id="data-container">
  ...
  <input type="checkbox" class="dd-input" id="test">
              ...
              <iframe src="<?= ($BASE) ?>/wkpis/datepicker/<?= ($kpidetails['kpi_id']) ?>"   width="900" frameborder="0" scrolling="yes" onload="this.style.height=(this.contentWindow.document.body.scrollHeight+200)+'px';" id="iframe"></iframe>
</li>
