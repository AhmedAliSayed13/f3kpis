                  ...
                  <div class="col-lg-9 col-md-8 col-5">
                      ...
                      <div id="right-menu">
                          <ul id="list-option" class="list-inline">
                              ...
                              <li class="list-inline-item header-items"><a href="/projections/show/group"><img src="<?= ($BASE) ?>/ui/images/icons/analytics-1.svg" alt=""/><span>التنبؤ</span></a></li>
                              <li class="list-inline-item header-items"><a href="/report/list/0"><img src="<?= ($BASE) ?>/ui/images/icons/magnifier-1.svg" alt=""/><span>نماذج البحث و الأسترجاع</span></a></li>
                         </ul>
                      </div>
                  </div>
                  <div class="col-lg-2 col-md-4 col-7">
                      <div class="logo-box">
                        <a href="/wkpis/home"><img id="list-option" src="<?= ($BASE) ?>/ui/images/logo.png" alt=""/></a></div>
                  </div>
              </div>
          </nav>
          <div id="profile-menu">
