...
<div class="container-fluid bg-white">
    <div class="row">
        ...
        <div class="col-12 text-right home-page proj-div d-flex">
            ...
            <?php if ($id==17 or $id==41): ?>
                <button data-toggle="modal" data-target="#proj17Modal" class="btn btn-info mr-2 btn-contractor"><i class="fas fa-search"></i> اختار مقاول</button>
            <?php endif; ?>
        </div>
    </div>
</div>
