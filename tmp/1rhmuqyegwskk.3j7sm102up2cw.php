  ...
  <div class="modal-content">
   ...
   <form method="post" action="">
    ...
    <div class="modal-footer text-left">
     <a  href="/projections/details/42" class=" btn btn-primary p-2 m-2"  type="submit">عرض</a>
    </div>
   </form>
  </div>
 </div>
 ...
 <div class="modal-dialog modal-dialog-centered">
  <div class="modal-content">
   ...
   <form method="post" action="">
    ...
    <div class="modal-footer text-left">
     <a  href="/projections/details/41" class=" btn btn-primary p-2 m-2"  type="submit">عرض</a>
    </div>
   </form>
  </div>
 </div>
 ...
 <div class="modal-dialog modal-dialog-centered">
  <div class="modal-content">
   ...
   <form method="post" action="">
    ...
    <div class="modal-footer text-left">
     <a  href="/projections/details/39" class=" btn btn-primary p-2 m-2"  type="submit">عرض</a>
    </div>
   </form>
  </div>
 </div>
